    ...
    >
      ...
      <div class="my-2">
        ...
        <small
          ...
          >Password must have at least 8 characters with the combination of
          number, lowercase and uppercase letter.</small
        >
      </div>
        ...
        >
          ...
          >
            <OptionCustom
              ...
              "
              v-bind:class="{
                'rounded-md shadow-inner bg-indigo-100': codeName === opt.val,
              }"
            />
          </template>
        </SelectCustom>
