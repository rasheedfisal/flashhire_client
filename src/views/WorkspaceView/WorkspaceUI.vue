...
<template>
  ...
  <div>
    ...
    <div class="max-w-5xl mx-auto max-md:mx-3 max-md:text-[0.95rem]">
      <h2 class="text-2xl font-semibold mt-20 mb-4 max-md:mt-12 max-md:text-xl">
            ...
            <div class="flex justify-between items-center py-4 relative">
              <div class="">
                ...
                <p class="max-md:text-sm">
                  Please update a new description for Full Stack Developer
                  about.....
                </p>
              </div>
              <div
              ...
              <span class="absolute top-0 right-1 max-md:top-4 max-md:right-0"
                ><small>19:58</small></span
              >
            </div>
          </template>
          <div class="flex justify-start items-center py-4 relative" v-else>
            <h4 class="text-lg text-indigo-300 italic">No unread message...</h4>
          </div>
        </template>
        <div class="flex justify-between items-center py-4 relative" v-else>
          <Loading color="indigo" />
        </div>
      </div>
      ...
      >
        ...
        <template v-if="isLoaded">
          <template v-if="officerList.length > 0">
            <div class="flex gap-4 py-4" v-for="theOfficer in officerList">
              <img
              ...
              <div class="">
                ...
                <p>
                  ...
                  <span v-if="user.name === theOfficer.user.name">(You)</span>
                </p>
              </div>
            </div>
          </template>
          <div class="flex gap-4 justify-between items-center py-4" v-else>
            <h4 class="text-lg text-indigo-300 italic">
