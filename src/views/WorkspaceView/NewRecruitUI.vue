...
async function addNewRecruit() {
  ...
  if (response.status !== 201) {
    toggleToastMsg("Failed to create new job recruitment. Please try again.");
  } else {
    designation.value = "";
    department.value = "";
    minsalary.value = "";
  ...
  <div class="max-w-7xl mx-auto px-6 max-md:px-3">
    ...
    >
      ...
      <form v-on:submit.prevent="addNewRecruit()">
        ...
        <div class="mt-4 max-w-lg">
          <label class="mb-2 block">Candidate minimum education level</label>
          <input
            type="text"
            class="block w-full rounded-md border-2 border-gray-300 px-4 py-2 bg-gray-50 hover:outline-none focus:outline-none focus:border-indigo-400 placeholder:text-gray-300"
        ...
        <div class="mt-4 max-w-lg">
          <label class="mb-2 block">Candidate year(s) of experience</label>
          <SelectCustom
            v-model="experience"
            heightselect="40"
            widthselect="full"
          ...
          >
            <template v-for="opt in ['0', '1', '2', '3', '4', '5', '10']">
              <OptionCustom
                ...
                "
                v-bind:class="{
                  'rounded-md shadow-inner bg-indigo-100': experience === opt,
                }"
              />
            </template>
          </SelectCustom>
        ...
        <div class="mt-4 max-w-lg">
          <label class="mb-2 block">Candidate Language requirement</label>
          <input
            type="text"
            class="block w-full rounded-md border-2 border-gray-300 px-4 py-2 bg-gray-50 hover:outline-none focus:outline-none focus:border-indigo-400 placeholder:text-gray-300"
            placeholder="English"
                ...
                v-on:click="
                  () => {
                    if (arrJobType.includes(thisType)) {
                      arrJobType = arrJobType.filter((el) => el !== thisType);
          ...
          >
            ...
            >
              <OptionCustom
                ...
                "
                v-bind:class="{
                  'rounded-md shadow-inner bg-indigo-100': jobField === opt,
                }"
              />
            </template>
          </SelectCustom>
        ...
        <div class="mt-4 max-w-lg">
          ...
          >
            <template
              v-for="opt in ['Saved Later', 'Waiting Approval', 'Approved']"
            >
              <OptionCustom
                v-bind:optionvalue="opt"
                v-on:click="
