          ...
          <div class="mt-4" v-for="interview in interviewList">
              ...
              >
                <div class="flex flex-col">
                  ...
                  <button
                    class="py-2 px-4 text-left hover:rounded-md hover:shadow-inner hover:bg-indigo-100"
                    v-on:click="
                      removeCandidateInterview(interview.candidate_profile.id)
                    "
                  >
            ...
            >
              ...
              <div class="flex flex-col gap-1">
                ...
                <p v-if="interview.candidate_profile.education.length > 0">
                  <i class="bi bi-book"></i> &nbsp;&nbsp;
                  {{
                    interview.candidate_profile.education[
                      interview.candidate_profile.education.length - 1
                    ].study_field
                  }}
                </p>
                <p
                ...
                >
                  ...
                  {{
                    interview.candidate_profile.work_experience[
                      interview.candidate_profile.work_experience.length - 1
                    ].duration
                  }}
                  experience at
                  {{
                ...
                <p>
                  ...
                  RM{{ interview.candidate_profile.preferred_salary }}
                </p>
              </div>
            </div>
          </div>
