    ...
    >
      ...
      <template v-if="isLoaded">
          ...
          <div class="mt-4" v-for="appl in applicantList">
            <div class="relative group">
              <button class="absolute top-0 right-0">
                <i class="bi bi-three-dots-vertical text-lg relative"></i>
              </button>
              <div
              ...
              >
                <div class="flex flex-col">
                  ...
                  <button
                    class="py-2 px-4 text-left hover:rounded-md hover:shadow-inner hover:bg-indigo-100"
                    v-on:click="removeFromApplicant(appl.candidate_profile.id)"
                  >
            ...
            >
              <img
                v-bind:src="appl.candidate_profile.user.pic"
              ...
              <div class="flex flex-col gap-1">
                ...
                <p v-if="appl.candidate_profile.education.length > 0">
                  <i class="bi bi-book"></i> &nbsp;&nbsp;
                  {{
                    appl.candidate_profile.education[
                      appl.candidate_profile.education.length - 1
                    ].study_field
                  }}
                </p>
                <p v-if="appl.candidate_profile.work_experience.length > 0">
                  <i class="bi bi-briefcase"></i> &nbsp;&nbsp;
                  {{
                    appl.candidate_profile.work_experience[
                      appl.candidate_profile.work_experience.length - 1
                    ].duration
                  }}
                  experience at
                  {{
                ...
                <p>
                  <i class="bi bi-cash"></i> &nbsp;&nbsp; Preferred Salary :
                  RM{{ appl.candidate_profile.preferred_salary }}
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="mt-4 py-4" v-else>
          <h4 class="text-lg text-indigo-300 italic">No applicant here...</h4>
        </div>
      </template>
