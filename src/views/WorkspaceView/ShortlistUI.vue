          ...
          <div class="mt-4" v-for="short in shortlist">
              ...
              >
                <div class="flex flex-col">
                  ...
                  <button
                    class="py-2 px-4 text-left hover:rounded-md hover:shadow-inner hover:bg-indigo-100"
                    v-on:click="
                      removeCandidateShortlist(short.candidate_profile.id)
                    "
                  >
            ...
            >
              ...
              <div class="flex flex-col gap-1">
                ...
                <p v-if="short.candidate_profile.education.length > 0">
                  <i class="bi bi-book"></i> &nbsp;&nbsp;

                  {{
                    short.candidate_profile.education[
                      short.candidate_profile.education.length - 1
                    ].study_field
                  }}
                </p>
                <p v-if="short.candidate_profile.work_experience.length > 0">
                  <i class="bi bi-briefcase"></i> &nbsp;&nbsp;
                  {{
                    short.candidate_profile.work_experience[
                      short.candidate_profile.work_experience.length - 1
                    ].duration
                  }}
                  experience at
                  {{
                ...
                <p>
                  ...
                  RM{{ short.candidate_profile.preferred_salary }}
                </p>
              </div>
            </div>
          </div>
