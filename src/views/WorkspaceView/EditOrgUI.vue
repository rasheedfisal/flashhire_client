...
async function submitEditOrg() {
  const response = await fetch(baseEndpoint + "/company/" + company.value.id, {
    method: "PATCH",
    mode: "cors",
      ...
      >
        ...
        <div class="flex flex-col gap-2">
          ...
          <small class="text-gray-500"
            >Support JPG and PNG. Max file size 3MB. Make sure image scale is
            1x1</small
          >
        </div>
      </div>
          ...
          >
            <template v-for="opt in countries">
              <OptionCustom
                ...
                "
                v-bind:class="{
                  'rounded-md shadow-inner bg-indigo-100': country === opt,
                }"
              />
            </template>
          </SelectCustom>
      ...
      <div class="mb-8">
        ...
        >
          <p class="font-semibold mt-4">
            ...
            organization info and other information associated to your
            organization. Are you absolutely sure?
          </p>
          <div class="mt-4">
            <label class="mb-2 block"
              >Please type the organization name and official website to confirm
              your action</label
            >
            <input
              type="text"
          ...
          <div class="mt-6">
            <button
              ...
              v-on:click="toggleDeleteSection()"
              v-bind:disabled="
                orgName !== company.name || orgWebsite !== company.website
              "
              v-bind:class="{
                'disabled:cursor-not-allowed opacity-60':
                  orgName !== company.name || orgWebsite !== company.website,
    ...
    >
      ...
      >
        ...
        <p class="text-center" v-if="successUpload">
          Successfully uploaded your resume. You can close the modal dialog.
        </p>
      </div>
    </DialogModal>
    <DialogModal
