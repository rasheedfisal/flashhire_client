          ...
          <div class="mt-4" v-for="success in successfulList">
              ...
              >
                <div class="flex flex-col">
                  ...
                  <button
                    class="py-2 px-4 text-left hover:rounded-md hover:shadow-inner hover:bg-indigo-100"
                    v-on:click="
                      removeCandidateSuccess(success.candidate_profile.id)
                    "
                  >
            ...
            <div class="flex gap-4 py-4 max-md:block">
              ...
              <div class="flex flex-col gap-1">
                ...
                <p v-if="success.candidate_profile.education.length > 0">
                  <i class="bi bi-book"></i> &nbsp;&nbsp;
                  {{
                    success.candidate_profile.education[
                      success.candidate_profile.education.length - 1
                    ].study_field
                  }}
                </p>
                <p v-if="success.candidate_profile.work_experience.length > 0">
                  <i class="bi bi-briefcase"></i> &nbsp;&nbsp;
                  {{
                    success.candidate_profile.work_experience[
                      success.candidate_profile.work_experience.length - 1
                    ].duration
                  }}
                  experience at
                  {{
                ...
                <p>
                  ...
                  RM{{ success.candidate_profile.preferred_salary }}
                </p>
              </div>
            </div>
          </div>
