  ...
  <div class="max-w-7xl mx-auto px-6 max-md:px-3">
    ...
    >
      <div class="mt-2 flex items-center gap-2">
        <router-link
          v-bind:to="`/workspace/recruitment/` + job.id + `/applicant-list`"
      ...
      <div class="mt-4 flex gap-4 max-md:flex-col">
        <img
          v-bind:src="applicant.candidate_profile.user.pic"
          alt=""
        ...
        <div class="max-md:text-[0.9rem]">
          ...
          <div class="mb-4">
            ...
            <ul class="list-disc list-inside px-2">
              <template v-if="applicant.candidate_profile.education.length > 0">
                <li v-for="edu in applicant.candidate_profile.education">
          ...
          <div class="mb-4">
            ...
            <ul class="list-disc list-inside px-2">
              <template
                v-if="applicant.candidate_profile.work_experience.length > 0"
              >
                <li v-for="exp in applicant.candidate_profile.work_experience">
          ...
          <div class="mb-4">
            ...
            <ul class="list-disc list-inside px-2">
              <template
                v-if="applicant.candidate_profile.lang_ability.length > 0"
              >
                <li v-for="lang in applicant.candidate_profile.lang_ability">
          ...
          <div class="mb-4">
            ...
            <ul class="list-disc list-inside px-2">
              <template v-if="applicant.candidate_profile.skill.length > 0">
                <li v-for="sk in applicant.candidate_profile.skill">
          ...
          <div class="mb-4">
            ...
            <ul class="list-disc list-inside px-2">
              <li v-if="applicant.candidate_profile.resume.length > 0">
                <span
          ...
          <div class="mb-4">
            ...
            <p class="text-indigo-300 italic px-6" v-if="notes === ''">
              No notes added...
            </p>
            <p class="px-6" v-else>
              {{ notes }}
      ...
      >
        <br />
        <br />
        <PdfRenderer v-bind:link="applicant.candidate_profile.resume[0].path" />
      </DialogModal>
      <DialogModal
