  ...
  <div class="max-w-7xl mx-auto px-6 max-md:px-3">
    ...
    >
      <div class="mt-2 flex items-center gap-2">
        <router-link
          v-bind:to="`/workspace/recruitment/` + job.id + `/shortlist`"
      ...
      <div class="mt-4 flex gap-4 max-md:flex-col">
        <img
          v-bind:src="short.candidate_profile.user.pic"
          alt=""
        ...
        <div class="max-md:text-[0.9rem]">
          ...
          <div class="mb-4">
            ...
            <ul class="list-disc list-inside px-2">
              <template v-if="short.candidate_profile.education.length > 0">
                <li v-for="edu in short.candidate_profile.education">
          ...
          <div class="mb-4">
            ...
            <ul class="list-disc list-inside px-2">
              <template
                v-if="short.candidate_profile.work_experience.length > 0"
              >
                <li v-for="exp in short.candidate_profile.work_experience">
          ...
          <div class="mb-4">
            ...
            <ul class="list-disc list-inside px-2">
              <template v-if="short.candidate_profile.lang_ability.length > 0">
                <li v-for="lang in short.candidate_profile.lang_ability">
          ...
          <div class="mb-4">
            ...
            <ul class="list-disc list-inside px-2">
              <template v-if="short.candidate_profile.skill.length > 0">
          ...
          <div class="mb-4">
            ...
            <ul class="list-disc list-inside px-2">
              <li v-if="short.candidate_profile.resume.length > 0">
                <span
      ...
      >
        <br />
        <br />
        <PdfRenderer v-bind:link="short.candidate_profile.resume[0].path" />
      </DialogModal>
      <DialogModal
