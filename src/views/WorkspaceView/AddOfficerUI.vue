...
<template>
  ...
  <div class="max-w-7xl mx-auto px-6 max-md:px-3">
    ...
    >
      ...
      <div class="mt-4">
        <p>
          You can add officer for this organization through invitation link. You
          can choose either only
        ...
        <p class="mt-2">
          Thus, enter the officer email (preferably official organization
          email), and define the role of that officer you want to add.
        </p>
      </div>
