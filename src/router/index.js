...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () => import("../views/GetStartedView/CreateAdminUI.vue"),
    },
    {
    ...
    {
      path: "/profile",
      component: () => import("../views/ApplicantView/BaseApplicantUI.vue"),
      ...
      children: [
        ...
        {
          path: "notifications",
          component: () => import("../views/ApplicantView/NotificationUI.vue"),
        },
        {
          path: "inbox",
          component: () => import("../views/ApplicantView/InboxUI.vue"),
        },
        {
          path: "inbox/message",
          component: () => import("../views/ApplicantView/RedirectInboxUI.vue"),
        },
        {
          path: "inbox/message/:receiverId",
          component: () => import("../views/ApplicantView/MessageUI.vue"),
        },
        {
          path: "user-info",
          component: () => import("../views/ApplicantView/UserProfileUI.vue"),
        },
        {
          path: "education",
          component: () => import("../views/ApplicantView/EducationUI.vue"),
        },
        {
          path: "work-experience",
          component: () => import("../views/ApplicantView/ExperienceUI.vue"),
        },
        {
          path: "lang-ability",
          component: () => import("../views/ApplicantView/LangAbilityUI.vue"),
        },
        {
          path: "skill",
          component: () => import("../views/ApplicantView/SkillUI.vue"),
        },
        {
          path: "resume",
          component: () => import("../views/ApplicantView/ResumeUI.vue"),
        },
        {
          path: "wishlist",
          component: () => import("../views/ApplicantView/WishlistUI.vue"),
        },
        {
          path: "applied-job",
          component: () => import("../views/ApplicantView/AppliedJobUI.vue"),
        },
      ],
    },
    {
    ...
    {
      path: "/workspace",
      component: () => import("../views/WorkspaceView/BaseWorkspaceUI.vue"),
      children: [
        {
          path: "",
          component: () => import("../views/WorkspaceView/WorkspaceUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        {
          path: "notifications",
          component: () => import("../views/WorkspaceView/NotificationUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        {
          path: "user-info",
          component: () => import("../views/WorkspaceView/UserProfileUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        {
          path: "inbox",
          component: () => import("../views/WorkspaceView/InboxUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        {
          path: "inbox/message",
          component: () => import("../views/WorkspaceView/RedirectInboxUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        {
          path: "inbox/message/:receiverId",
          component: () => import("../views/WorkspaceView/MessageUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        },
        {
          ...
          component: () => import("../views/WorkspaceView/NewRecruitUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        },
        {
          ...
          component: () => import("../views/WorkspaceView/ViewRecruitUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        },
        {
          ...
          component: () => import("../views/WorkspaceView/RecruitDetailUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        },
        {
          ...
          component: () => import("../views/WorkspaceView/EditRecruitUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        },
        {
          ...
          component: () => import("../views/WorkspaceView/ApplicantListUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        },
        {
          ...
          component: () => import("../views/WorkspaceView/RedirectListUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        },
        {
          ...
          component: () =>
            import("../views/WorkspaceView/ApplicantCandidateUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        },
        {
          ...
          component: () => import("../views/WorkspaceView/ShortlistUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        },
        {
          ...
          component: () =>
            import("../views/WorkspaceView/ShortlistCandidateUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        },
        {
          ...
          component: () => import("../views/WorkspaceView/InterviewListUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        },
        {
          ...
          component: () =>
            import("../views/WorkspaceView/InterviewCandidateUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        },
        {
          ...
          component: () =>
            import("../views/WorkspaceView/SuccessfulCandidateUI.vue"),
          meta: {
            requiresAuth: true,
            roles: [
              "admin",
        ...
        {
          path: "settings",
          component: () => import("../views/WorkspaceView/SettingsUI.vue"),
          meta: {
            requiresAuth: true,
        ...
        },
        {
          ...
          component: () => import("../views/WorkspaceView/EditOrgUI.vue"),
          meta: {
            requiresAuth: true,
            roles: ["admin", "admin,hr", "admin,manager"],
          },
        },
        {
          ...
          component: () => import("../views/WorkspaceView/TrashBinUI.vue"),
          meta: {
            requiresAuth: true,
            roles: ["admin", "admin,hr", "admin,manager"],
          },
        },
        {
          ...
          component: () => import("../views/WorkspaceView/AddOfficerUI.vue"),
          meta: {
            requiresAuth: true,
            roles: ["admin", "admin,hr", "admin,manager"],
          },
        },
        {
          ...
          component: () => import("../views/WorkspaceView/ListResignUI.vue"),
          meta: {
            requiresAuth: true,
            roles: ["admin", "admin,hr", "admin,manager"],
          },
...
router.beforeEach(async (to, from, next) => {
  ...
  isNotWorkspace.value = to.path !== "/workspace" && to.path !== "/workspace/";
